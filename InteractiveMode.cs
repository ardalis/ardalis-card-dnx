...
public static class InteractiveMode
{
    public static async Task<int> RunAsync()
    {
        ...
        AnsiConsole.MarkupLine("[dim]Enter commands (blog, bluesky, books, card, contact, courses, dometrain, linkedin, packages, quote, recent, repos, speaker, tips, youtube). Press Ctrl+C or type 'exit' to quit.[/]\n");
